...
//			System.out.println();
			...
			InetAddress[] addrs = InetAddress.getAllByName("www.naver.com"); // allbyname은 가지고있는 ip주소 다가져옴
			...
			InetAddress[] addrs2 = InetAddress.getAllByName("m.naver.com"); // allbyname은 가지고있는 ip주소 다가져옴
			for (InetAddress k : addrs2) {
				System.out.println("이름 : " + k.getHostName());
				System.out.println("주소 : " + k.getHostAddress());
				System.out.println("toString : " + k.toString());
				System.out.println();

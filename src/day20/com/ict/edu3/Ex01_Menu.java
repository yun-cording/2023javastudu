...
public class Ex01_Menu extends JFrame implements ActionListener, ItemListener {
	...
	public Ex01_Menu() {
		...
		jp1 = new JPanel();
		jp1.add(new JLabel("자바 피자에 오신걸 환영합니다."));
		
		
		jp2 = new JPanel();
		bg1 = new ButtonGroup(); // 3개 선택중 한개를 고르게 할 수 있게 그룹을 지정해둠 안해두면 개별로 다 체크 가능하다
		jrb1 = new JRadioButton("콤보(15000)",true);// 기본적으로 버튼 체크 되어있어야해서 true
		...
		jp2.add(jrb2);
		jp2.add(jrb3);
		jp2.setBorder(BorderFactory.createTitledBorder("종류")); // 그룹을 묶는

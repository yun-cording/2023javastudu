...
//				JOptionPane.showConfirmDialog(parsentComponent , message , title , optionType);
				// 	optionType : YES_NO_CANCEL_OPTION(예 , 아니요 , 취소) , YES_NO_OPTION(예 , 아니요 , 취소),
				//				 OK_CANCEL_OPTION(확인 , 취소) , YES_NO_OPTION(예 , 아니요 , 취소),
//				JOptionPane.showConfirmDialog(jp , "정말 삭제할까요?","확인창",JOptionPane.YES_NO_OPTION);
		...
		jb3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//	String msg = JOptionPane.showInputDialog(parsentComponent , message);
...
//		JOptionPane.showOptionDialog(parentComponent , message, title, optionType, meggageType, null, null , null);
//				int res =JOptionPane.showOptionDialog(jp , "반가워 ", "사용자 다이얼 로그",JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE , null, null , null);
//				System.out.println(res);
				int res =JOptionPane.showOptionDialog(jp , "반가워 ", "사용자 다이얼 로그",JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE , null, null , null);
				System.out.println(res);
			}
